...
export default function ChatPage() {
  ...
  return (
    ...
    <main className="h-[100dvh] flex flex-col animate-fade-in-up overflow-hidden">
      ...
      <header className="flex-none p-4 flex justify-between items-center border-b border-white/10 bg-black/10 backdrop-blur-sm z-10">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="hidden md:flex gap-3">
            ...
            <a 
              href="https://github.com/decimasudo/siren-ai" 
              target="_blank" 
              rel="noopener noreferrer"
              className="p-2 rounded-lg bg-white/5 hover:bg-white/10 transition-colors"
      ...
      <nav className="flex gap-2 justify-center p-2 bg-black/5 border-b border-white/5">
        <button
      ...
      <div className="flex-1 flex flex-col lg:flex-row min-h-0">
        ...
        {/* Content Section (Right Panel) - Hidden on mobile, shown on lg+ */}
        <div className="hidden lg:flex lg:w-1/2 flex-col border-l border-white/10 bg-white/5 relative">
      ...
      {showChatModal && (
        <div className="modal-overlay" onClick={() => setShowChatModal(false)}>
          <div className="modal-content max-w-4xl w-full h-4/5 flex flex-col" onClick={(e) => e.stopPropagation()}>
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold">Chat with Siren</h2>
              <button
            ...
            <div className="flex-1 overflow-y-auto p-4 scrollbar-thin scrollbar-thumb-white/20">
              <ChatMessages messages={chat.messages} />
              <div ref={messagesEndRef} />
            </div>
